...
Name:           ros-rolling-draco-point-cloud-transport
Version:        3.0.2
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS draco_point_cloud_transport package

License:        BSD
URL:            https://wiki.ros.org/draco_point_cloud_transport
Source0:        %{name}-%{version}.tar.gz

Requires:       draco-devel
...
%description
draco_point_cloud_transport provides a plugin to point_cloud_transport for
sending point clouds encoded with KD tree compression.
...
%changelog
* Tue Feb 20 2024 Martin Pecka <peckama2@fel.cvut.cz> - 3.0.2-2
